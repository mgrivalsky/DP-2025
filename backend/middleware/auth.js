...
const DISABLE_AUTH_REQUESTED = String(process.env.DISABLE_AUTH || '').toLowerCase() === 'true';
const DISABLE_AUTH = !isProd && DISABLE_AUTH_REQUESTED;

const authenticateToken = (req, res, next) => {
  if (isProd && DISABLE_AUTH_REQUESTED) {
    console.warn('[auth] DISABLE_AUTH=true ignored in production');
  }
