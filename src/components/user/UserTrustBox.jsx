      ...
      <div className="container">
        <div className="section-title text-center">
          ...
          <p className="user-trustbox__intro">
            Schránka dôvery je priestor, kde môžu naši študenti, rodičia aj zamestnanci anonymne alebo verejne vyjadriť svoje postrehy, pocity, návrhy či obavy. Veríme, že otvorená komunikácia je základom príjemného a bezpečného školského prostredia. Ak aj vy chcete prispieť, neváhajte využiť našu{" "}
